                ...
                <div class="col-12">
                    <div class="card section-card">
                        ...
                        <div class="card-body mt-3 bg-white">
                            <div class="row g-2">
                                <div class="col-md-4">
                                    <a class="btn btn-outline-primary w-100" href="<?php echo BASE_URL; ?>app/request_items.php">Request Items</a>
                                </div>
                                <div class="col-md-4">
                                    <a class="btn btn-outline-secondary w-100" href="<?php echo BASE_URL; ?>app/facility_records.php">Facility Records</a>
                                </div>
                                <div class="col-md-4">
                                    <a class="btn btn-outline-secondary w-100" href="<?php echo BASE_URL; ?>app/personal_records.php">Personal Inventory</a>
                                </div>
                            </div>
