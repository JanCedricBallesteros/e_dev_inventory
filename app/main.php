<?php
## THIS FILE IS FOR TEMPLATE OR SAMPLE
...
## page header title
$general_page_title = "Dashboard";
$get_user_value = strtoupper($_GET['none'] ?? ''); ## change based on key
$page_header_title = ACCESS_NAME[$get_user_value] ?? $general_page_title;
$header_breadcrumbs = []; ## ['label' => $page_header_title, 'url' => '']

## verify user access [change depends on allowed user access]
if (!($g_user_role == "ADMIN" || $g_user_role == "REGISTRAR" || $g_user_role == "DEAN" || $g_user_role == "STUDENT")) {
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img
                                                                        src="../assets/dashboard/img/flags/id.png"
                                                                        alt="indonesia" />
                                                                </div>
                                                            </td>
                                                            <td>Indonesia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img
                                                                        src="../assets/dashboard/img/flags/us.png"
                                                                        alt="united states" />
                                                                </div>
                                                            </td>
                                                            <td>USA</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img
                                                                        src="../assets/dashboard/img/flags/au.png"
                                                                        alt="australia" />
                                                                </div>
                                                            </td>
                                                            <td>Australia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img
                                                                        src="../assets/dashboard/img/flags/ru.png"
                                                                        alt="russia" />
                                                                </div>
                                                            </td>
                                                            <td>Russia</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img
                                                                        src="../assets/dashboard/img/flags/cn.png"
                                                                        alt="china" />
                                                                </div>
                                                            </td>
                                                            <td>China</td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="flag">
                                                                    <img
                                                                        src="../assets/dashboard/img/flags/br.png"
                                                                        alt="brazil" />
                                                                </div>
                                                            </td>
                                                            <td>Brasil</td>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-list py-4">
                                        <div class="item-list">
                                            <div class="avatar">
                                                <img
                                                    src="../assets/dashboard/img/jm_denis.jpg"
                                                    alt="..."
